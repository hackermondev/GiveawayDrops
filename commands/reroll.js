...
module.exports = {
  execute: async (client, message, args) => {
    ...
    await client.giveaways.rerollGiveaways({
      giveawayID: giveaway[0].giveawayID
    })

    message.channel.send(client.embeds.success(`The giveaway has been rerolled succesfully.`, message.author))
  },
  help: {
    name: `greroll`,
    description: `Reroll a giveaway in the channel.`,
    alias: ['reroll'],
    cooldown: 0
  }
}